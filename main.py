...
""")
                    ...
                    with gr.Accordion("🚀 Try Demo Scenarios (Presentation Mode)", open=False):
                        ...
                        sim_mode_toggle = gr.Checkbox(label="Enable Instant Simulation (Demo Mode)", value=False)
                        gr.HTML("<div style='font-size:0.75em;color:var(--c-amber);line-height:1.2;margin-top:-5px;'>Bypass slow AI inference for preset scenarios during presentations.</div>")
